...
skipped_keys = ["train", "test", "prepare", "preprocess", "rotate", "presplit", "help", "generate", 
                "script_concept", "script_weeks", "script_spatial_prior", "script_mean_template", "test_loaders", "test_pipe", 
...
def print_custom_help(config_ns, help_ns):
    ...
    print("  python main.py --preprocessing.params.gtpp.params.desired_size=\"[128,128,128]\"\n")
